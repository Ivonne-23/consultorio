    ...
    <div class="container bg-white">
        <div class="row">
            <div class="col-2 bg-primary p-4 text-white vh-100">
                ...
                <h5 class="p-2"><i class="bi bi-person-badge"></i> Odontologos</h5>
                <h4 class="p-2"><i class="bi bi-person-lines-fill"></i> Pacientes</h4>
                <h4 class="p-2"><a href="{{url('citas')}}" class=" btn text-decoration-none {{request()->routeIs('citas')?'active_custom':''}} text-white"><i class="bi bi-calendar-check"></i> Citas</a></h4>
                <h5 class="p-2"><i class="bi bi-file-earmark-medical"></i> Expedientes</h5>
                <h4 class="p-2"><i class="bi bi-bar-chart"></i> Reportes</h4>
                <h5 class="p-2"><i class="bi bi-gear"></i> Configuración</h5>
                <h4 class="p-2 text-white"><i class="bi bi-box-arrow-right"></i> Cerrar Sesión</h4>
            </div>
